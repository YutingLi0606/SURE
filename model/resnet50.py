...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, use_cos=False, cos_temp=8):
        self.inplanes = 64
...
def ResNet50(num_classes, use_cos, cos_temp, pretrained=False, **kwargs):
    """Constructs a ResNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 6, 3], num_classes, use_cos, cos_temp, **kwargs)
    if pretrained:
